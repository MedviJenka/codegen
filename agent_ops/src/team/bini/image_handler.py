...
class CompressAndUploadImage(AzureLLMConfig):
    ...
    def upload_image(self, image_path: str, prompt: str, sample_image: Optional[str or list] = None) -> str:
            ...
            message.content.append(
                {
                    "type": "image_url",
                    "image_url": {
                        "url": f"data:image/jpeg;base64,{self.__encode_image(sample_image)}"
                    }
                }
            )
